...
<table id="testtable2" >
    ...
    <div class="itab">
  	<ul> 
    <li><a href="#tab1" class="selected">修改教师信息信息</a></li> 
    ...
    <div class="formtext">Hi，<b>admin</b>，欢迎您使用修改教师信息功能！</div>
    <form action="xiugaiInput.jsp" method="post">
    <ul class="forminfo">
     <li><label>教师编号<b>*</b></label><input name="id" type="text" value="<%=teacher.getId() %>" class="dfinput" placeholder="编号"   style="width:518px;"/></li>
    <li><label>教师姓名<b>*</b></label><input name="name" type="text" value="<%=teacher.getName() %>"class="dfinput" placeholder="姓名"  style="width:518px;"/></li>
     <li><label>教师身份证号<b>*</b></label><input name="num" type="text"value="<%=teacher.getNum() %>" class="dfinput" placeholder="身份证号"  style="width:518px;"/></li>
      <li><label>教师住址<b>*</b></label><input name="address" type="text" class="dfinput" placeholder="住址"  style="width:518px;"/></li>
       <li><label>教师电话<b>*</b></label><input name="phone" type="text" class="dfinput" placeholder="电话"  style="width:518px;"/></li>
        <li><label>教师部门<b>*</b></label><input name="department" type="text" class="dfinput" placeholder="部门"  style="width:518px;"/></li>
         ...
         <li><label>教师参加工作时间<b>*</b></label><input name="time" type="text" value="<%=teacher.getTime() %>" class="dfinput" placeholder="参加工作时间"  style="width:518px;"/></li>
          ...
          <li><label>教师专业<b>*</b></label><input name="major" type="text" class="dfinput" placeholder="专业"  style="width:518px;"/></li>
           <li><label>教师职务<b>*</b></label><input name="duty" type="text" class="dfinput" placeholder="职务"  style="width:518px;"/></li>
            <li><label>教师出生年月<b>*</b></label><input name="birth" type="text" value="<%=teacher.getBirth() %>" class="dfinput" placeholder="出生年月"  style="width:518px;"/></li>
  <!--   </li>
